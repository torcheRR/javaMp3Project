...
public class Song {
    ...
    public Song(String filePath){
        ...
        try {
            ...
            songLenght = convertToSongLenghtFormat();

            //use the jaudiotagger library to create an audio file obj to read mp3 file's info
            ...
            if (tag!=null){
                ...
                //could not read the mp3 file's meta data
                songTitle="N/A";
                songArtist="N/A";
            }
